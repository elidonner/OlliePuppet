...
if control.registrySection.Exists("type_c_serial") = false
control.registrySection.Write("type_c_serial","1")
...
control.serial.SetUserData("0")
control.serial.SetInverted(0)
